...
exports.apiRouter.patch("/api/contacts/:contactId(\\d+)", contact_controller_1.ContactController.update);
...
exports.apiRouter.patch("/api/contacts/:contactId(\\d+)/addresses/:addressId(\\d+)", address_controller_1.AddressController.update);
