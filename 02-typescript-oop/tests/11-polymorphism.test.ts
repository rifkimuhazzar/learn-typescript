describe("Polymophism", () => {
  ...
  function sayHello(object: Manager): void {
    console.log(`Hello ${object.name}`);
  }

  function sayHello2(employee: Employee) {
  ...
  function sayHello2Wrong(employee: Employee) {
  ...
  it("should be able to do polymorphism in object", () => {
    ...
    let manager: Manager = new Manager("Next");
    console.log(manager);
